...
* [Spring Data Couchbase](https://docs.spring.io/spring-boot/docs/3.1.5/reference/htmlsingle/index.html#data.nosql.couchbase)
...
```
$ docker run --rm springdata-multicluster:0.0.1-SNAPSHOT
```
...
```
$ target/springdata-multicluster
```
